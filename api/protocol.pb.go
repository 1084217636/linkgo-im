...
func (x *GetHistoryReq) GetBeforeSeq() int64 {
	if x != nil {
		return x.BeforeSeq
	}
	return 0
...
func (x *GetHistoryReply) GetNextBeforeSeq() int64 {
	if x != nil {
...
func (x *GetHistoryReply) GetHasMore() bool {
	if x != nil {
		return x.HasMore
	}
	return false
...
type Conversation struct {
	...
	AckedSeq       int64                  `protobuf:"varint,9,opt,name=acked_seq,json=ackedSeq,proto3" json:"acked_seq,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *Conversation) GetAckedSeq() int64 {
	if x != nil {
		return x.AckedSeq
	}
	return 0
...
const file_api_protocol_proto_rawDesc = "" +
	...
	"\bmessages\x18\x01 \x03(\v2\x10.api.WireMessageR\bmessages\x12&\n" +
	...
	"\rconversations\x18\x03 \x03(\v2\x11.api.ConversationR\rconversations\"\x91\x02\n" +
	"\fConversation\x12'\n" +
	...
	"\tacked_seq\x18\t \x01(\x03R\backedSeq\"O\n" +
	"\rSendToUserReq\x12$\n" +
