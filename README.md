...
如果本地已经用旧版 SQL 初始化过 MySQL，需要按需执行 `sql/20260518_conversations.sql`、`sql/20260611_v1_message_idempotency.sql`、`sql/20260611_contacts_groups.sql` 和 `sql/20260703_red_packets.sql`；全新环境直接使用 `sql/init.sql` 即可。
