...
活动控制面已经实现配置校验、不可覆盖版本、operator 提交、reviewer/admin 发布、创建者禁止自审、0–100 灰度比例、admin 回滚，以及 MySQL 事务内审计/Outbox。Redis 更新失败不会丢失发布事件，Gateway 会周期扫描 pending Outbox 并幂等重放。
